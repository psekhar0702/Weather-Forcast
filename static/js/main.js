...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // ✅ Travel Advice only after user clicks button
  ...
  if (adviceBtn) {
    adviceBtn.addEventListener('click', () => {
      ...
      } else if (weather.includes('rain') || weather.includes('storm') || weather.includes('snow') || weather.includes('thunder') || weather.includes('drizzle')|| weather.includes('scattered cloud')||weather.includes('overcast cloud')) {
